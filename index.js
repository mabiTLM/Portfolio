...
const projectArr = {
  ...
  thirdProject: { details: "제일 처음으로 진행한 연습과 흥미를 겸한 프로젝트<br>텍스트로만 구성됐다가 후에 프론트가 추가 되는 등 처음 설계가 웹에는 맞지 않는 부분이 있어서 미완성 상태입니다.<br><br><a href='https://github.com/mabiTLM/Java4/tree/makeDungeon_0824'>텍스트로만 구현된 던전탐험</a><br><a href='https://github.com/mabiTLM/Java4/tree/makeCardGame230901'>자바로 구현한 카드게임</a><br><a href='https://github.com/mabiTLM/Java4/tree/makeWebCardGameServlet'>서블렛으로 프론트를 넣은 카드게임</a>" },
};
